        ...
        <div class="col-md-12 text-<?=$align?> <?=$dir?> w3-padding-32-h">
            ...
            if(mysqli_affected_rows2() > 0) {
                ...
                <div class="w3-margin-top w3-padding-top w3-center" style="margin-top: 30px">
                    <?php
                    nav_5("page", $pagesize, "laws", $_GET["page"], " w3-margin-bottom btn", "btn background_brown  w3-margin-bottom", "where active =1 $parent_search   $query_add order by the_order, id desc");
                    ?>
                </div>
