	...
	$(document).ready(function(){
			...
			$(".detail").click(function(){
                $("#dialog").html(" <div style='text-align: center'><img src='images/load.gif'></div>")
					$("#dialog").load("data_events.php?id=" + $(this).attr("ids"));
...
<td class="th" align="center"> العنوان </span></td>
<td class="th" align="center"> الاختصاص</span></td>
<td class="th" align="center">  البلد</span></td>
...
<? $res=mysqli_query2("select * from ".$table."  order by ".$sort."  limit $start,$pagesize");
$i=0;
